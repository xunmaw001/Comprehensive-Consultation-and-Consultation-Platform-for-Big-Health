...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../xzpnstatic/css/color.css">
...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in yishengRecommend" v-bind:key="index">
                <a target="_self" :href="'../yishengzuozhen/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.touxiang" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in jiankangzixunList" v-bind:key="index">
                <a target="_self" :href="'../jiankangzixun/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.tupian?item.tupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.zixunbiaoti}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`yishengzuozhen/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.yishengRecommend = res.data.list;
      });

      http.request(`jiankangzixun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.jiankangzixunList = res.data.list;
      });
    });
  </script>
</body>
