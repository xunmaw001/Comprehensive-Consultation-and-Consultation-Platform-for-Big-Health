    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <textarea name="informationContent" id="informationContent">请输入要咨询的内容</textarea>
                </div>
            </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
        ...
        form.on('submit(*)', function(data) {
            ...
            debugger
            var informationContent = tinymce.get('#informationContent').getContent()
            data.informationContent = informationContent;
            data.ysTypes = window.sessionStorage.getItem('idd')
            http.requestJson('jiaoliu' + '/save', 'post', data, function(res) {
                layer.msg('提交成功', {
                    time: 2000,
                    icon: 6
                }, function() {
