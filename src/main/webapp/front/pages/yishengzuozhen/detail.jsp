        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                ...
                <div class="detail-item">
                    <span>擅长领域：</span>
                    <span class="desc">
								{{detail.shanzhanglingyu}}
							</span>
                </div>
                <div class="detail-item">
                    <span>坐诊时间：</span>
                    <span class="desc">
								{{detail.zuozhenshijian}}
							</span>
                </div>
                <div class="detail-item">
                    <span>挂号价格：</span>
                ...
                <div class="detail-item" style="text-align: right;">
                    ...
                    <button v-if="isAuth('yishengzuozhen','预约挂号')" @click="onAcrossTap('yuyueguahao')" type="button"
                            class="layui-btn">
                        预约挂号
                    </button>
                    <button onclick="zixun()" type="button"
                            class="layui-btn">
                        咨询
                    </button>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            onAcrossTap(acrossTable) {
                localStorage.setItem('crossTable', `yishengzuozhen`);
